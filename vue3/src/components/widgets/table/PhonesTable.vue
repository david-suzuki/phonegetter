  ...
  <div class="card" :class="widgetClasses">
    ...
    <div class="card-header border-0 pt-5">
      <h3 class="card-title align-items-start flex-column">
        <span class="card-label fw-bolder fs-3 mb-1">{{ translate("phoneNumbersStatistics") }}</span>
      </h3>
            ...
            <template v-for="(phone, index) in pagedRows" :key="phone.id">
              <tr>
                ...
                <td class="text-end">
                  ...
                  <a
                    href="javascript:void(0)" @click="deletePhone(index, phone.id)"
...
export default defineComponent({
  ...
  mounted(){
    ...
    axios
    .get("http://localhost:8000/phones/list", { headers: authHeader })
    .then((response)=>
    { 
  ...
  methods: {
    deletePhone(index, id) {
      ...
      axios
      .get("http://localhost:8000/phones/delete/" + id, { headers: authHeader })
      .then((response) => { 
