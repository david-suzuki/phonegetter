  ...
  <div class="card" :class="widgetClasses">
    ...
    <div class="card-header border-0 pt-5">
      <h3 class="card-title align-items-start flex-column">
        <span class="card-label fw-bolder fs-3 mb-1">{{ translate("adminitratorsStatistics") }}</span>
      </h3>
    ...
    <div class="card-body py-3">
      ...
      <div class="table-responsive">
        ...
        >
          ...
          <!--begin::Table body-->
          <tbody>
            <template v-for="(admin, index) in pagedRows" :key="admin.id">
              <tr>
                ...
                <td class="text-end">
                  ...
                  <a
                    href="javascript:void(0)" @click="deleteAdmin(index, admin.id)"
...
export default defineComponent({
  ...
  mounted(){
    ...
    axios
    .get("http://localhost:8000/admins/list", { headers: authHeader })
    .then((response)=>
    { 
  ...
  methods: {
    deleteAdmin(index, id) {
      ...
      axios
      .get("http://localhost:8000/admins/delete/" + id, { headers: authHeader })
      .then((response) => { 
        this.admins.splice(index, 1);  
      }).catch((err) => {
        Swal.fire({
          text: "Administrator delete fail.",
          icon: "error",
    ...
    nextPage:function() {
      if ((this.currentPage*this.pageSize) < this.admins.length) this.currentPage++;
    },
